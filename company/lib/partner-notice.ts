...
export const PARTNER_NOTICE: Record<Locale, { title: string; body: string; link: string }> = {
  ko: { title: "OTIT 등재 정보의 범위", body: "OTIT 등재로 확인할 수 있는 것은 기능실습 송출기관 여부입니다. 특정기능 송출 실적이나 자격을 증명하지는 않습니다. 또한 일본 정부의 네팔 안내에 따르면, 특정기능 절차에서 송출기관 이용은 의무가 아닙니다.", link: "일본 출입국재류관리청 네팔 안내" },
  ...
  ja: { title: "OTIT掲載情報の範囲", body: "OTITへの掲載で確認できるのは、技能実習の送出機関であることです。特定技能の送出実績や資格を証明するものではありません。また、出入国在留管理庁のネパール案内によると、特定技能手続で送出機関の利用は必須ではありません。", link: "出入国在留管理庁・ネパール案内" },
