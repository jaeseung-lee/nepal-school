...
const FAQS = [
  {
    q: "정우인재개발원은 어떤 회사인가요?",
    a: "정우인재개발원은 네팔과 베트남 인재를 현지 직업훈련부터 양성해 한국과 일본 기업에 합법적으로 연결하는 글로벌 인적자원 개발 기업입니다.",
  },
  {
    q: "어떤 취업비자와 제도를 지원하나요?",
    a: "한국은 E-9, E-7, D-2, D-4, E-8을 지원하고 일본은 특정기능 1호를 지원합니다. 기업 요건과 직무에 맞는 제도를 검토합니다.",
  },
  {
    q: "채용은 어떤 절차로 진행되나요?",
  ...
  {
    q: "어느 나라의 인재를 연결하나요?",
    a: "네팔과 베트남 현지에서 양성한 인재를 한국과 일본 기업에 연결합니다. 현재 협력망은 4개국을 중심으로 운영됩니다.",
  },
  {
    q: "신생 기업인데 신뢰할 수 있나요?",
    a: "검증 가능한 객관 지표만 공개하고 확인할 수 없는 취업자 수나 순위는 표기하지 않습니다. Richhood Overseas와의 MOU를 포함한 협력 체계를 기반으로 운영합니다.",
  },
];
