...
const TYPES = [
  {
    code: "E-7-1",
    title: "전문인력",
    desc: "관리자·전문가 직종. 학위와 전공-직무 연관성이 핵심 심사 요소입니다.",
  },
  {
    code: "E-7-2",
    title: "준전문인력",
    desc: "사무·서비스 분야의 준전문 직종. 직종별로 학력·경력 조합 요건이 적용됩니다.",
  },
  {
    code: "E-7-3",
    title: "일반기능인력",
    desc: "특정 기능 직종. 해당 분야 경력과 자격이 요구됩니다.",
  },
  {
    code: "E-7-4",
    title: "숙련기능인력",
    desc: "국내 장기 체류 이력을 점수제로 평가해 전환하는 유형. E-9 인력의 장기 고용 경로로 주목받습니다.",
  },
];
...
const PROCESS_STEPS = [
  {
    title: "직종 해당 여부 확인",
    desc: "채용하려는 직무가 법무부 고시 E-7 허용 직종에 해당하는지 확인합니다. 여기서 갈리면 다른 제도를 검토해야 합니다.",
  },
  {
