...
function buildEmailDrafts(company: string, jobs: string) {
  return {
    ja: `${company}\n採用ご担当者様\n\n突然のご連絡失礼いたします。Jeongwoo Human Resource Development Instituteの［担当者名］です。\n\n貴社の公開求人（${jobs || "介護職"}）を拝見し、ネパール人介護人材の採用条件を伺いたく、ご連絡しました。弊社は、日本での就業を目指すネパール人材に、日本語・介護・就業前の準備を行っています。\n\n現在募集されている職種、在留資格、日本語力、入社時期を伺ったうえで、条件に合う候補者がいる場合にご紹介します。まずは15分ほど、オンラインか訪問でお話しできないでしょうか。\n\nご案内が不要な場合は、その旨をご返信ください。以後のご連絡は差し控えます。\n\nJeongwoo Human Resource Development Institute\n［氏名・法人連絡先・住所］`,
    ko: `${company}\n채용 담당자님께\n\n안녕하세요. 정우인재개발원 [담당자명]입니다.\n\n공개하신 채용 공고(${jobs || "개호직"})를 보고, 네팔 개호 인재의 채용 조건을 여쭙고자 연락드렸습니다. 저희는 일본 취업을 준비하는 네팔 인재에게 일본어·개호 교육과 취업 전 준비를 지원합니다.\n\n현재 모집 중인 직무와 재류자격, 일본어 수준, 입사 시기를 확인한 뒤 조건에 맞는 후보자를 안내하겠습니다. 15분 정도 온라인이나 방문으로 말씀 나눌 수 있을까요?\n\n연락을 원하지 않으시면 회신 부탁드립니다. 이후 연락을 중단하겠습니다.\n\n정우인재개발원\n[이름·법인 연락처·주소]`,
  };
}
