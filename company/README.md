...
- [ ] 파트너 로고 3종(Richhood / KTS / 대한주택건설협회) + **서면 사용 허락**
...
**사업영역 상세**
- [x] 한국어·일본어 상세 4페이지: 일본 개호, 일본 호텔·호스피탈리티, 한국 유학, 한국 용접
- [ ] 실제 제휴 대학, 호텔 과정 시수, 용접 훈련사진·자격 근거 등 미확정 자료는 확보 후 보강

**미구현 페이지(기획엔 있으나 현재 없음)**
- [ ] 회사소개 상세(인사말/미션·비전/연혁/오시는 길) · 자료실(News)/FAQ
